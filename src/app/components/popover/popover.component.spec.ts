...
describe('PopoverComponent', () => {
  ...
  it('should render the header', () => {
    expect(
      fixture.nativeElement.querySelector('app-header-popover')
    ).toBeTruthy();
  });

  it('should render the body', () => {
    expect(
      fixture.nativeElement.querySelector('app-popover-body-text')
    ).toBeTruthy();
    expect(
      fixture.nativeElement.querySelector('.popover-ticket-hours')
    ).toBeTruthy();
  });
